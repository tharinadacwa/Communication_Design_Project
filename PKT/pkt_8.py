...
class pkt_8(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.epy_block_1 = epy_block_1.blk(file_path="C:/Users/Subodha/Desktop/3rd Semester/CDP/PKT/output.txt")
        self.epy_block_0 = epy_block_0.blk(file_path="C:/Users/Subodha/Desktop/3rd Semester/CDP/PKT/input.txt", repeat_count=100, period=0.1)
        ...
        self.msg_connect((self.digital_crc_check_0, 'ok'), (self.epy_block_1, 'in'))
        ...
        self.msg_connect((self.epy_block_0, 'out'), (self.blocks_message_debug_1, 'print'))
        self.msg_connect((self.epy_block_0, 'out'), (self.digital_crc_append_0, 'in'))
        ...
        self.connect((self.blocks_uchar_to_float_0_0_0, 0), (self.qtgui_time_sink_x_1, 0))
