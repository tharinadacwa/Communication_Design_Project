...
class srnew(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.epy_block_14 = epy_block_14.messenger_gui(bg_image="")
        ...
        self.msg_connect((self.epy_block_12, 'status_out'), (self.epy_block_14, 'feedback'))
        self.msg_connect((self.epy_block_13, 'ack_out'), (self.digital_crc_append_0_0, 'in'))
        self.msg_connect((self.epy_block_14, 'out'), (self.epy_block_12, 'msg_in'))
        self.msg_connect((self.epy_block_14, 'dest_addr'), (self.epy_block_12, 'dest_addr_in'))
        ...
        self.msg_connect((self.epy_block_3_3, 'pdus_out'), (self.epy_block_14, 'in'))
