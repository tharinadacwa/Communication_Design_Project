...
import cdp_epy_block_2_0_0 as epy_block_2_0_0  # embedded python block
...
class cdp(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, MTU=1500):
        ...
        self.k = k = 7
        self.hdr_format = hdr_format = digital.header_format_default('1110000101011010111010001001001111100001010110101110100010010011',1, 1)
        ...
        self.soapy_bladerf_source_0_0.set_frequency(0, 2.48e9)
        self.soapy_bladerf_source_0_0.set_frequency_correction(0, 0)
        self.soapy_bladerf_source_0_0.set_gain(0, min(max(50.0, -1.0), 60.0))
        ...
        self.soapy_bladerf_sink_0_0 = soapy.sink(dev, "fc32", 1, '',
                                  stream_args, tune_args, settings)
        self.soapy_bladerf_sink_0_0.set_sample_rate(0, samp_rate_blade*2)
        self.soapy_bladerf_sink_0_0.set_bandwidth(0, 10000)
        self.soapy_bladerf_sink_0_0.set_frequency(0, 2.48e9)
        self.soapy_bladerf_sink_0_0.set_frequency_correction(0, 0)
        self.soapy_bladerf_sink_0_0.set_gain(0, min(max(50e3, 17.0), 73.0))
        ...
        for c in range(1, 2):
            self.controls_grid_layout_1.setColumnStretch(c, 1)
        self.epy_block_4_0 = epy_block_4_0.crc_forwarder(retry_limit=2, ack_batch_size=4, sync_len=2000)
        self.epy_block_3_0 = epy_block_3_0.address_check(my_address=50)
        self.epy_block_3 = epy_block_3.address_check(my_address=10)
        self.epy_block_2_0_0 = epy_block_2_0_0.pdu_text_gui(wait_time=0.1, pkt_size=100, address=50, retry_limit=100, window_size=7, sync_bits=1e4)
        self.epy_block_0_1_0 = epy_block_0_1_0.messenger_gui(bg_image='Networks_Telecommunications1.jpg')
        self.epy_block_0 = epy_block_0.address_add()
        ...
        self.msg_connect((self.epy_block_0_1_0, 'dest_addr'), (self.epy_block_0, 'addr_in'))
        self.msg_connect((self.epy_block_0_1_0, 'out'), (self.epy_block_2_0_0, 'in'))
        self.msg_connect((self.epy_block_2_0_0, 'out'), (self.digital_crc_append_0, 'in'))
        self.msg_connect((self.epy_block_2_0_0, 'feedback'), (self.epy_block_0_1_0, 'feedback'))
        self.msg_connect((self.epy_block_3, 'out'), (self.epy_block_4_0, 'in'))
        self.msg_connect((self.epy_block_3_0, 'out'), (self.epy_block_2_0_0, 'ack_in'))
        self.msg_connect((self.epy_block_4_0, 'ack_out'), (self.digital_protocol_formatter_async_0_0, 'in'))
        self.msg_connect((self.epy_block_4_0, 'out'), (self.epy_block_0_1_0, 'in'))
        ...
        self.connect((self.blocks_multiply_const_vxx_0_0, 0), (self.soapy_bladerf_sink_0_0, 0))
    ...
    def set_samp_rate_blade(self, samp_rate_blade):
        ...
        self.soapy_bladerf_sink_0_0.set_sample_rate(0, self.samp_rate_blade*2)
