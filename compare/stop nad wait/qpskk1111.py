...
import qpskk1111_epy_block_11 as epy_block_11  # embedded python block
import qpskk1111_epy_block_13 as epy_block_13  # embedded python block
import qpskk1111_epy_block_3_3 as epy_block_3_3  # embedded python block
import qpskk1111_epy_block_7 as epy_block_7  # embedded python block
import qpskk1111_epy_block_8 as epy_block_8  # embedded python block
import sip
import threading
...
class qpskk1111(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.soapy_bladerf_source_0_0.set_gain(0, min(max(25.0, -1.0), 60.0))
        ...
        self.soapy_bladerf_source_0.set_gain(0, min(max(60.0, -1.0), 60.0))
        ...
        self.soapy_bladerf_sink_0_0 = soapy.sink(dev, "fc32", 1, 'bladerf=0',
                                  stream_args, tune_args, settings)
        self.soapy_bladerf_sink_0_0.set_sample_rate(0, samp_rate)
        self.soapy_bladerf_sink_0_0.set_bandwidth(0, 10000)
        self.soapy_bladerf_sink_0_0.set_frequency(0, freq1)
        self.soapy_bladerf_sink_0_0.set_frequency_correction(0, 0)
        self.soapy_bladerf_sink_0_0.set_gain(0, min(max(60.0, 17.0), 73.0))
        ...
        for c in range(2, 3):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.epy_block_8 = epy_block_8.ChatInterface()
        ...
        self.epy_block_13 = epy_block_13.ack_sync_prepender(sync_len_bytes=10000)
        self.epy_block_11 = epy_block_11.TextToPDU_ARQ(max_packet_size=32, src_address=1, dest_address=2)
        ...
        self.msg_connect((self.digital_crc_check_0, 'ok'), (self.epy_block_11, 'ack_bits'))
        ...
        self.msg_connect((self.epy_block_11, 'pdus'), (self.digital_crc_append_0, 'in'))
        self.msg_connect((self.epy_block_11, 'status_out'), (self.epy_block_8, 'status_in'))
        ...
        self.msg_connect((self.epy_block_8, 'msg_out'), (self.epy_block_11, 'msg_in'))
        ...
        self.connect((self.digital_constellation_modulator_0_0, 0), (self.soapy_bladerf_sink_0_0, 0))
        ...
        self.connect((self.soapy_bladerf_source_0, 0), (self.digital_symbol_sync_xx_0_0, 0))
    ...
    def set_freq1(self, freq1):
        self.freq1 = freq1
        self.soapy_bladerf_sink_0_0.set_frequency(0, self.freq1)
