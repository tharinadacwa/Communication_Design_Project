...
class qpskk1111(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.soapy_bladerf_sink_0.set_bandwidth(0, 200e3)
        ...
        for c in range(2, 3):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.epy_block_2 = epy_block_2.blk(file_path=r"C:\Users\Subodha\Desktop\3rd Semester\CDP\ACK\input.txt"
        , interval=0.1, max_packet_size=32)
