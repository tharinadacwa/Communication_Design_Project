...
class receiver(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.epy_block_0 = epy_block_0.blk(file_path=r"C:/Users/Subodha/Desktop/3rd Semester/CDP/ACK/output.txt", append=True)
        ...
        self.msg_connect((self.epy_block_3, 'ack_packet_out'), (self.blocks_message_debug_1, 'log'))
