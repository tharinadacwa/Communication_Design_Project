...
class MediaReceiver(gr.top_block, Qt.QWidget):

    def __init__(self, MTU=4090):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "MediaReceiver")
...
def argument_parser():
    ...
    parser.add_argument(
        "--MTU", dest="MTU", type=intx, default=4090,
        help="Set MTU [default=%(default)r]")
    return parser


def main(top_block_cls=MediaReceiver, options=None):
    if options is None:
