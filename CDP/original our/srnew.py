...
class srnew(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.epy_block_13 = epy_block_13.ack_sync_prepender(sync_len_bytes=100)
        self.epy_block_12 = epy_block_12.TextToPDU_ARQ(pkt_size=32, src_addr=1, dst_addr=2, sync_burst_bytes=100, timeout=0.08, retry_limit=30)
