...
import qpskk1111_epy_block_0_1 as epy_block_0_1  # embedded python block
import qpskk1111_epy_block_0_1_0 as epy_block_0_1_0  # embedded python block
import qpskk1111_epy_block_2_0_0_0 as epy_block_2_0_0_0  # embedded python block
import qpskk1111_epy_block_3_4 as epy_block_3_4  # embedded python block
import qpskk1111_epy_block_4_0_0 as epy_block_4_0_0  # embedded python block
import sip
import threading



class qpskk1111(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "qpskk1111")
        ...
        self._noise_volt_range = qtgui.Range(0, 1, 0.01, 0.6, 200)
        ...
        self.epy_block_4_0_0 = epy_block_4_0_0.crc_forwarder(retry_limit=2, ack_batch_size=4, sync_len=2000)
        self.epy_block_3_4 = epy_block_3_4.address_check(my_address=10)
        self.epy_block_2_0_0_0 = epy_block_2_0_0_0.TextToPDU_StopWait_Addr(wait_time=0.1, pkt_size=100, src_address=10, dest_address=50, retry_limit=100, sync_bits=1e4)
        self.epy_block_0_1_0 = epy_block_0_1_0.messenger_gui(bg_image='Networks_Telecommunications1.jpg')
        self.epy_block_0_1 = epy_block_0_1.address_add()
        ...
        # Connections
        ##################################################
        self.msg_connect((self.digital_crc_append_0, 'out'), (self.epy_block_0_1, 'in'))
        self.msg_connect((self.digital_crc_check_0, 'ok'), (self.epy_block_2_0_0_0, 'ack_in'))
        ...
        self.msg_connect((self.epy_block_0_1, 'out'), (self.digital_protocol_formatter_async_0, 'in'))
        self.msg_connect((self.epy_block_0_1_0, 'dest_addr'), (self.epy_block_0_1, 'addr_in'))
        self.msg_connect((self.epy_block_0_1_0, 'out'), (self.epy_block_2_0_0_0, 'in'))
        self.msg_connect((self.epy_block_2_0_0_0, 'out'), (self.digital_crc_append_0, 'in'))
        self.msg_connect((self.epy_block_2_0_0_0, 'feedback'), (self.epy_block_0_1_0, 'feedback'))
        self.msg_connect((self.epy_block_3_4, 'out'), (self.epy_block_4_0_0, 'in'))
        self.msg_connect((self.epy_block_4_0_0, 'ack_out'), (self.digital_protocol_formatter_async_0_0, 'in'))
        self.msg_connect((self.epy_block_4_0_0, 'out'), (self.epy_block_0_1_0, 'in'))
        self.msg_connect((self.pdu_tagged_stream_to_pdu_0_0, 'pdus'), (self.digital_crc_check_0, 'in'))
        self.msg_connect((self.pdu_tagged_stream_to_pdu_0_0_0, 'pdus'), (self.epy_block_3_4, 'in'))
        ...
        self.connect((self.channels_channel_model_0_0, 0), (self.zeromq_pub_sink_0_0, 0))
...
def main(top_block_cls=qpskk1111, options=None):
