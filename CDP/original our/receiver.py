...
import receiver_epy_block_0 as epy_block_0  # embedded python block
import receiver_epy_block_3 as epy_block_3  # embedded python block
import receiver_epy_block_4 as epy_block_4  # embedded python block
import sip
import threading
...
class receiver(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.freq2 = freq2 = 5e9
        self.freq1 = freq1 = 2.4e9
        self.excess_bw = excess_bw = 0.35
        self.equalizer = equalizer = 15
        self.delay = delay = 50
        ...
        for c in range(2, 3):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._equalizer_range = qtgui.Range(15, 100, 1, 15, 200)
        ...
        self.zeromq_pub_sink_0 = zeromq.pub_sink(gr.sizeof_gr_complex, 1, 'tcp://127.0.0.1:5556', 100, False, (-1), '', True, True)
        ...
        self.epy_block_4 = epy_block_4.blk(idle_byte=170)
        self.epy_block_3 = epy_block_3.blk(address=2, max_packet_size=32)
        self.epy_block_0 = epy_block_0.blk(file_path=r"C:\Users\Subodha\Desktop\CDP\original our\output.txt", append=True)
        ...
        self.digital_linear_equalizer_0 = digital.linear_equalizer(equalizer, 4, variable_adaptive_algorithm_0, True, [ ], 'corr_est')
        ...
        self.msg_connect((self.digital_crc_check_0, 'ok'), (self.epy_block_3, 'pdus_in'))
        ...
        self.msg_connect((self.epy_block_3, 'ack_packet_out'), (self.digital_crc_append_0, 'in'))
        self.msg_connect((self.epy_block_3, 'pdus_out'), (self.epy_block_0, 'pdus'))
        ...
        self.connect((self.blocks_tagged_stream_mux_0, 0), (self.epy_block_4, 0))
        ...
        self.connect((self.epy_block_4, 0), (self.digital_constellation_modulator_0, 0))
