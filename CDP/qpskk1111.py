...
import qpskk1111_epy_block_1 as epy_block_1  # embedded python block
import qpskk1111_epy_block_8 as epy_block_8  # embedded python block
import qpskk1111_epy_block_9 as epy_block_9  # embedded python block
import sip
import threading
...
class qpskk1111(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.epy_block_9 = epy_block_9.blk(preamble_len=1000, repeat_count=1000, repeat_interval_seconds=0.1, src_address=1, dest_address=2)
        self.epy_block_8 = epy_block_8.ChatInterface()
        self.epy_block_1 = epy_block_1.blk(tag_key="packet_len", packet_bytes=8)
        ...
        self.msg_connect((self.epy_block_8, 'msg_out'), (self.epy_block_9, 'msg_in'))
        self.msg_connect((self.epy_block_9, 'pdus'), (self.digital_crc_append_0, 'in'))
        self.msg_connect((self.epy_block_9, 'status_out'), (self.epy_block_8, 'status_in'))
        self.msg_connect((self.pdu_tagged_stream_to_pdu_0_0, 'pdus'), (self.digital_crc_check_0, 'in'))
        self.connect((self.blocks_repack_bits_bb_1_0_0, 0), (self.epy_block_1, 0))
        self.connect((self.blocks_tagged_stream_mux_0, 0), (self.digital_constellation_modulator_0, 0))
        self.connect((self.blocks_throttle2_0, 0), (self.channels_channel_model_0, 0))
        self.connect((self.blocks_throttle2_0_0, 0), (self.digital_pfb_clock_sync_xxx_0, 0))
        ...
        self.connect((self.epy_block_1, 0), (self.pdu_tagged_stream_to_pdu_0_0, 0))
