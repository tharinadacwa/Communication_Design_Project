...
import qpskk1111_epy_block_0 as epy_block_0  # embedded python block
import qpskk1111_epy_block_2 as epy_block_2  # embedded python block
import sip
import threading
...
class qpskk1111(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.pdu_tagged_stream_to_pdu_0 = pdu.tagged_stream_to_pdu(gr.types.byte_t, 'packet_len1')
        ...
        for c in range(2, 3):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.epy_block_2 = epy_block_2.blk(file_path=r"C:\Users\Subodha\Desktop\3rd Semester\CDP\input.txt"
        , interval=1, repeat_count=1)
        ...
        self.blocks_stream_to_tagged_stream_0 = blocks.stream_to_tagged_stream(gr.sizeof_char, 1, 64, "packet_len1")
        ...
        self.msg_connect((self.digital_crc_check_0, 'ok'), (self.epy_block_0, 'pdus'))
        ...
        self.msg_connect((self.epy_block_2, 'pdus'), (self.digital_crc_append_0, 'in'))
        ...
        self.msg_connect((self.pdu_tagged_stream_to_pdu_0_1, 'pdus'), (self.blocks_message_debug_0_0, 'log'))
        ...
        self.connect((self.blocks_tagged_stream_mux_0, 0), (self.pdu_tagged_stream_to_pdu_0_1, 0))
