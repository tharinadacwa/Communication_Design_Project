...
class str_pkt_10(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "str_pkt_10", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("str_pkt_10")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "str_pkt_10")
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/barry/GRdev/padded.txt', False, 0, 0)
...
def main(top_block_cls=str_pkt_10, options=None):
